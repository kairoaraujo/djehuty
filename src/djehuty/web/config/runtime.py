...
class RuntimeConfiguration:  # pylint: disable=too-few-public-methods
    ...
    def __init__(self):
        ...
        self.migrations_graph = "https://data.4tu.nl/portal/migrations"
        self.auto_migrate_on_boot = True
        self.privileges = {}
        ...
        self.usage_statistics_enabled = False
        self.usage_statistics_database_url = None
        self.usage_statistics_flush_interval = 5
        self.usage_statistics_flush_batch_size = 1000
